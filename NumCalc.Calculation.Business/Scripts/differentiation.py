...
from differentiation_methods import differentiation_lagrange, finite_diff_forward, finite_diff_backward, finite_diff_central
...
def solve_lagrange(
    ...
    return differentiation_lagrange.solve(x_nodes, y_values, query_point, expression, order)
