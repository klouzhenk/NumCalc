...
def solve_rectangle(expression: str, lower_bound: float, upper_bound: float, n: int, variant: str) -> str:
    return rectangle.solve(expression, lower_bound, upper_bound, n, variant)
